...
- **Pricing stated exactly as true, everywhere:** tracking (vitals, meds,
  ...
  items, extracted in one go) are Premium at $14.99/mo. Free accounts get
...
> for life before it's $14.99/mo — a single out-of-pocket lab panel can
...
> life so you can see if it's worth it, then $14.99/mo. Tracking, the
...
> report, chat, AI-assisted entry) are $14.99/month, with exactly one free
...
One scan-and-report free for life so you can judge it yourself. After that it's $14.99/mo. Tracking, the health score, trends, and the Tests Due card stay free forever, no account, no catch — a single out-of-pocket lab panel alone can cost more than a month of Premium.
