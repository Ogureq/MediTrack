...
/// Gemocode's two in-app legal documents — Terms of Service and Privacy
...
/// fully offline, matching Gemocode's local-first design, with hosted
...
/// a common boilerplate privacy-policy claim doesn't fit Gemocode's
...
/// glass-styled to match the rest of Gemocode.
        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    Text("This document describes Gemocode's actual, current behavior. It is not a substitute for independent legal advice.")
                        .font(.caption)
