...
struct HealthReview {
    ...
    static let disclaimer = """
        MediTrack provides educational information only. It is not a medical device, does not \
    ...
    var shareText: String {
        var lines: [String] = []
        lines.append("MediTrack Health Review — \(generatedAt.formatted(date: .abbreviated, time: .shortened))")
