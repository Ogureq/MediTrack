...
// MediTrackWidgets extension. The extension target cannot see this module,
// so `MediTrackWidgets/HealthScoreWidget.swift` intentionally duplicates
