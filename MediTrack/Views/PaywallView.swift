...
struct PaywallView: View {
    ...
    private var activeCard: some View {
        HStack(spacing: 10) {
            ...
            Text("Premium is active on this device. Thank you for supporting MediTrack.")
    ...
    private var featureList: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            PaywallFeatureRow(
                ...
                detail: "New AI tools land here first as MediTrack grows."
            )
            PaywallFeatureRow(
                icon: "heart.fill",
                title: "Support ongoing development",
                detail: "MediTrack has no ads and sells no data — premium is what keeps it going."
            )
        }
        .padding(16)
        .frame(maxWidth: .infinity, alignment: .leading)
    ...
    private var unavailableCard: some View {
        HStack(alignment: .top, spacing: 10) {
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                Text("This preview isn't connected to the App Store yet, so premium plans can't be shown or purchased here. Everything else in MediTrack works normally.")
                    .font(.footnote)
