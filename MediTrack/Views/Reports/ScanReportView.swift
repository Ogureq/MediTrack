...
struct ScanReportView: View {
    ...
    private var lockedCard: some View {
        VStack(spacing: 14) {
            ...
            Text("Scan Lab Reports with Premium")
                .font(.headline)
            Text("Photograph or import a lab report and MediTrack extracts your results automatically — no manual typing.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
            Button {
        ...
        .glassCard()
        .accessibilityElement(children: .combine)
        .accessibilityLabel("Scan lab reports with Premium. Photograph or import a lab report and MediTrack extracts your results automatically.")
    ...
    private func presentCamera() {
        ...
        case .denied, .restricted:
            cameraAlertMessage = "Camera access is disabled for MediTrack. Enable it in Settings, or use Import PDF or Photo instead."
            showingCameraAlert = true
        @unknown default:
...
private struct ScanReportHeader: View {
    var body: some View {
        VStack(spacing: 10) {
            ...
            Text("Scan a Report")
                .font(.title2.bold())
            Text("Photograph or import a document — MediTrack reads the lab values for you.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .multilineTextAlignment(.center)
        }
