...
- **MediTrack Premium** — $19.99/month (or yearly) unlocks everything AI: unlimited AI health reports, chat about your results, and AI-assisted natural-language entry, powered by a metered relay so you never need your own API key. One AI report is included free as a trial. Every local tracking feature — reports, OCR scanning, health score, interactions, trends, backups — is free forever.
