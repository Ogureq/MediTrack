...
- **MediTrack Premium** — Optional monthly or yearly subscription (via a Profile → MediTrack Premium paywall) that unlocks unlimited AI reports and future AI features. Every local tracking feature — reports, OCR scanning, health score, interactions, trends, backups — is free forever.
